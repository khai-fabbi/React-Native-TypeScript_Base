...
module.exports = {
  async apply(value, previousValues) {
    return new Promise(resolve => {
      console.log('\n');
      console.log(
        'TheCodingMachine React-Native MyAppReactnative initialized with success ! 🚀\n',
      );
      console.log(
        `${green(
          '                                                                    .-`    `::  \n' +
      ...
      console.log(
        '- 📚 If you need to read more about this myappreactnative : https://thecodingmachine.github.io/react-native-myappreactnative/',
      );
      console.log(
        '- 🤕 If you have some troubles : https://github.com/thecodingmachine/react-native-myappreactnative/issues',
      );
      console.log(
        '- ⭐ If you love this myappreactnative, give us a star, you will be a ray of sunshine in our lives :) https://github.com/thecodingmachine/react-native-myappreactnative',
      );
